...
FROM (
  ...
  WHERE lc.ano_referencia = 2024
) sub
WHERE tgt.id = sub.id;

SELECT COUNT(*) AS rows_2024, COUNT(drs) AS com_drs
FROM public.lc131_despesas WHERE ano_referencia = 2024;
