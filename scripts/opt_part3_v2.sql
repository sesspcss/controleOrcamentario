-- ================================================================
-- PARTE 3 OTIMIZADA — lc131_dashboard + lc131_distincts
-- Substitui a Parte 3 anterior. SELECT * → apenas colunas necessárias
-- para reduzir memória do CTE de ~100MB para ~20MB.
-- ================================================================
...
-- ── lc131_distincts (sem mudanças, apenas recria) ──
