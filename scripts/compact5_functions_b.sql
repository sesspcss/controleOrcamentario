-- ================================================================
-- COMPACTAR 5/5 — lc131_detail + refresh_dashboard + teste
-- ================================================================
...
-- Teste final
SELECT pg_size_pretty(pg_database_size(current_database())) AS tamanho_final;
SELECT lc131_dashboard(2026) IS NOT NULL AS dashboard_ok;
