-- ================================================================
-- PARTE 2b — Enriquecer ANO 2022 (~97k rows)
-- ================================================================
...
FROM (
  ...
  WHERE lc.ano_referencia = 2022
) sub
WHERE tgt.id = sub.id;

SELECT COUNT(*) AS rows_2022, COUNT(drs) AS com_drs
FROM public.lc131_despesas WHERE ano_referencia = 2022;
