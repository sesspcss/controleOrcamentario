...
const REGIONS: { lat: number; lng: number; kw: string[] }[] = [
  ...
  { lat: -23.02,  lng: -45.56, kw: ['taubaté','taubate','drs xvii','drs 17','rras 17'] },
  { lat: -23.65,  lng: -45.41, kw: ['rras 18','rras18','litoral norte','caraguatatuba','ubatuba'] },
  // Regiões Administrativas (regiao_ad) — coincidem com cidades-sede dos DRS
  { lat: -23.55,  lng: -46.63, kw: ['grande são paulo','grande sao paulo','grande sp','são paulo','sao paulo'] },
  { lat: -21.21,  lng: -50.43, kw: ['araçatuba','aracatuba'] },
  { lat: -21.78,  lng: -48.18, kw: ['araraquara'] },
  { lat: -23.96,  lng: -46.33, kw: ['baixada santista','litoral sul','santos'] },
  { lat: -20.55,  lng: -48.57, kw: ['barretos'] },
  { lat: -22.32,  lng: -49.07, kw: ['bauru'] },
  { lat: -22.91,  lng: -47.06, kw: ['campinas'] },
  { lat: -20.54,  lng: -47.40, kw: ['franca'] },
  { lat: -22.21,  lng: -49.95, kw: ['marília','marilia'] },
  { lat: -22.73,  lng: -47.65, kw: ['piracicaba','tietê','tiete'] },
  { lat: -22.12,  lng: -51.39, kw: ['presidente prudente'] },
  { lat: -24.49,  lng: -47.84, kw: ['registro','vale do ribeira'] },
  { lat: -21.17,  lng: -47.81, kw: ['ribeirão preto','ribeirao preto'] },
  { lat: -21.97,  lng: -46.80, kw: ['são joão','sao joao','boa vista'] },
  { lat: -20.82,  lng: -49.38, kw: ['rio preto','são josé do rio preto','sao jose do rio preto'] },
  { lat: -23.50,  lng: -47.45, kw: ['sorocaba'] },
  { lat: -23.02,  lng: -45.56, kw: ['vale do paraíba','vale do paraiba','taubaté','taubate','são josé dos campos','sao jose dos campos'] },
];
